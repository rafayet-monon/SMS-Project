                ...
                <div class="navbar navbar-inverse navbar-static-top">
                    <div class="navbar-inner">
                        <div class="container-fluid">
                            ...
                            <a class="brand" href="teacher_dashboard.jsp">SMS</a>
                            <!-- .topnav -->
                            <div class="btn-toolbar topnav">
                                ...
                                <div class="btn-group">
                                    <a class="btn btn-inverse" data-placement="bottom" data-original-title="Logout" rel="tooltip"
                                       href="Teacher_Logout_Controller"><i class="icon-off"></i></a></div>
                            </div>
                            <!-- /.topnav -->
                            <div class="nav-collapse collapse">
                                <!-- .nav -->
                                <ul class="nav">
                                    <li class="active"><a href="teacher_dashboard.jsp">Teacher Dashboard</a></li>
            ...
            <div id="left">
                ...
                <ul id="menu" class="unstyled accordion collapse in">
                    <li class="accordion-group active">
                        <a href="teacher_dashboard.jsp"><i class="icon-home icon-large"></i>Dashboard</a>
                    </li>
					...
					<li class="accordion-group ">
                        ...
                        <ul class="collapse " id="form-nav">
							...
							<li><a href="assignment.jsp"><i class="icon-angle-right"></i>Assignment</a></li>
					...
					<li class="accordion-group ">
                        ...
                        <ul class="collapse" id="error-nav">
							<li><a href="teacher_attendance_personal.jsp"><i class="icon-angle-right"></i>Teacher Attendance</a></li>
        ...
        <div class="col-sm-6">
			...
			<div aria-hidden="true" aria-labelledby="myModalLabel2" role="dialog" tabindex="-1" class="modal hide fade" id="myModal2">
                        <div class="modal-header">
                            ...
                            <h3 id="myModalLabel2">Edit Teacher Profile</h3>
                        </div>
                        <div class="modal-body">
                          <div id="collapse2" class="body collapse in">
                                            <form action="teacher_registration.jsp" class="form-horizontal" id="popup-validation">
                                                <div class="control-group">
                                                    <label class="control-label">Full Name</label>

                                                    <div class="controls">
                                                        <input type="text" class="validate[required] text-input" name="teacher_name" id="teacher_name" data-prompt-position="bottomLeft" value="Otto" >
                                                    </div>
                                                </div>
												<div class="control-group">
												...
												<div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="int" class="validate[required] text-input" name="teacher_id" id="teacher_id" data-prompt-position="bottomLeft" >
                                                    </div>
                                                </div>
        ...
        <div class="panel-body profile-view-dis">
            <h1>Personal Information</h1>
                    ...
                    <div class="profile-view-tab">
                        <p><span>Designation </span>: <% out.println(session.getAttribute("designation")); %></p>
                    </div>
                    ...
                    <div class="profile-view-tab">
                        <p><span>Joining Date </span>:<% out.println(session.getAttribute("joindate")); %></p>
                    </div>
                    <div class="profile-view-tab">
